  ...
  (gnus-with-article-buffer
    (save-excursion
      ...
      (when (re-search-forward
             "^\\(?:To view, visit \\)?\\(https://review.opendev.org/[0-9]+\\|https://bugs.launchpad.net/bugs/[0-9]+\\|https://bugzilla.redhat.com/show_bug.cgi\\?id=[0-9]+\\|https://github.com/.+/.+/\\(issues\\|pull\\)/[0-9]+\\|https://travis-ci.org/.+/.+/builds/.+\\)" nil t)
